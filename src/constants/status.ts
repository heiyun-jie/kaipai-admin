...
export const recruitProjectStatusMap: Record<number, { label: string; tone: 'info' | 'warning' | 'success' | 'danger' }> = {
  1: { label: '进行中', tone: 'success' },
  2: { label: '已结束', tone: 'warning' },
}

export const recruitRoleStatusMap: Record<string, { label: string; tone: 'info' | 'warning' | 'success' | 'danger' }> = {
  recruiting: { label: '招募中', tone: 'success' },
  paused: { label: '已暂停', tone: 'warning' },
  closed: { label: '已结束', tone: 'danger' },
}

export const recruitApplyStatusMap: Record<number, { label: string; tone: 'info' | 'warning' | 'success' | 'danger' }> = {
